...
sudo echo "remote_hosts=$public_ip" >> /home/ubuntu/apache-jmeter-5.6.2/bin/jmeter.properties
sudo echo "server_port=1099" >> /home/ubuntu/apache-jmeter-5.6.2/bin/jmeter.properties
